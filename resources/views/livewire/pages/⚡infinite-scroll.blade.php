...
new #[Layout('layouts.app'), Title('Infinite Scroll - LiveWire 4')] class extends Component {
    ...
    public function loadUsers()
    {
        ...
        $this->users = array_merge($this->users, $newUsers->toArray());
        $this->page++;
    }
}; ?>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="text-zinc-600 dark:text-zinc-400">
                Automatic loading with viewport detection using wire:intersect.
            </p>
        </div>
        ...
        <div
            ...
            <p class="text-sm text-blue-800 dark:text-blue-200 mb-3">
                This demo uses <strong>wire:intersect</strong> at the bottom of the list. When it enters the viewport,
                it automatically loads more items and appends them to the list.
            </p>
        ...
        <div class="bg-white dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 overflow-hidden">
            <div class="p-4 border-b border-zinc-200 dark:border-zinc-700">
                ...
                <p class="text-sm text-zinc-600 dark:text-zinc-400">Loaded {{ count($users) }} users</p>
            </div>
            ...
            <div wire:intersect="loadUsers" class="p-8 text-center bg-zinc-50 dark:bg-zinc-900"
                style="{{ count($users) >= App\Models\User::count() ? 'display: none;' : '' }}">
            ...
            @if (count($users) >= App\Models\User::count())
        ...
        <div class="mt-8 bg-white dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 p-6">
            ...
            <pre class="bg-zinc-900 text-zinc-100 p-4 rounded-lg overflow-x-auto text-xs"><code>@@foreach ($users as $user)
    &lt;div&gt;{{ $user['name'] }}&lt;/div&gt;
@@endforeach

@@if (count($users) &lt; User::count())
    &lt;div wire:intersect="loadUsers"&gt;
        Loading more...
    &lt;/div&gt;
@@endif
