...
new #[Layout('layouts.app'), Title('Advanced Islands - LiveWire 4')] class extends Component {
    ...
    public function incrementNamed()
    {
        ...
        // Explicitly render the named island to update both instances
...
<div class="p-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 p-6 mb-6">
            ...
            <div class="p-4 bg-zinc-50 dark:bg-zinc-900 rounded-lg">
                <p class="text-xs text-zinc-600 dark:text-zinc-400">
                    <strong>How it works:</strong> Both islands have <code
                        class="px-1.5 py-0.5 bg-zinc-200 dark:bg-zinc-700 rounded">name: 'counter'</code>,
        ...
        <div class="bg-white dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 p-6 mb-6">
            ...
            <p class="text-sm text-zinc-600 dark:text-zinc-400 mb-4">
                Imperatively render an island with custom data using <code
                    class="px-1.5 py-0.5 bg-zinc-100 dark:bg-zinc-700 rounded text-xs">$this->renderIsland()</code>.
            ...
            @island(name: 'items')
                <div class="space-y-2">
                    @foreach ($items as $index => $item)
                        <div
                            class="p-3 bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-200 dark:border-emerald-800 rounded-lg">
            ...
            <div class="mt-4 p-4 bg-zinc-50 dark:bg-zinc-900 rounded-lg">
                ...
                <ul class="text-xs text-zinc-600 dark:text-zinc-400 space-y-1 list-disc list-inside">
                    <li>"Add Item" uses <code
                            class="px-1 py-0.5 bg-zinc-200 dark:bg-zinc-700 rounded">renderIsland()</code> to append
                        instantly</li>
                    <li>"Stream Item" uses <code
                            class="px-1 py-0.5 bg-zinc-200 dark:bg-zinc-700 rounded">streamIsland()</code> to append
                        with streaming</li>
        ...
        <div class="bg-white dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 p-6 mb-6">
            ...
            <div class="p-4 bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-800 rounded-lg">
                <p class="text-sm text-amber-900 dark:text-amber-100 mb-2">
                    <strong>Use Case:</strong> Perfect for modals, dropdowns, or content that should only render
                    on-demand.
                </p>
                <p class="text-xs text-amber-700 dark:text-amber-300">
                    The island exists in the DOM as a placeholder but doesn't render until you call <code
                        class="px-1 py-0.5 bg-amber-200 dark:bg-amber-800 rounded">renderIsland()</code>.
                </p>
            </div>

            @island(skip: true, name: 'skipped')
                <div
                    class="mt-4 p-4 bg-purple-50 dark:bg-purple-900/10 border-2 border-dashed border-purple-500 rounded-lg">
        ...
        <div class="bg-white dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div
                        class="p-4 bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800 rounded-lg">
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="p-2 bg-blue-200 dark:bg-blue-700 rounded text-xs font-bold">← New Item
                                (Appended)</div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div
                        class="p-4 bg-pink-50 dark:bg-pink-900/10 border border-pink-200 dark:border-pink-800 rounded-lg">
                        <p class="text-xs text-pink-700 dark:text-pink-300 mb-2">New content is added to the beginning
                        </p>
                        <div class="space-y-1">
                            <div class="p-2 bg-pink-200 dark:bg-pink-700 rounded text-xs font-bold">← New Item
                                (Prepended)</div>
        ...
        <div class="bg-white dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 p-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    <h3 class="text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-2">Imperative Rendering (Append)
                    </h3>
                    <pre class="bg-zinc-900 text-zinc-100 p-4 rounded-lg overflow-x-auto text-xs">
                        <code>
                            public function addItem()
